...
<body>
    ...
    include'ketnoi.php'; 
        ...
        if (isset($_GET['maloaisp']) && !empty($_GET['maloaisp'])) {
            $loai = mysqli_query($conn, "SELECT * FROM `sanpham` where `maloaisp` = " . $_GET['maloaisp'] );
                ...
                while ($row = mysqli_fetch_array($loai)) {
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <a href="sanpham.php?masp=<?= $row['masp']?>"><img class="card-img-top" src=" <?= $row['anhdaidien'] ?> " alt=""></a>
                            <div class="card-body">
                                <h4 class="card-title">
